...
" Colors
    hi User2 ctermbg=darkyellow ctermfg=darkblue guibg=darkyellow guifg=darkblue
    hi User1 ctermbg=darkgray ctermfg=lightblue guibg=darkgray guifg=lightblue
    hi User3 ctermbg=darkgray ctermfg=lightcyan guibg=darkgray guifg=lightcyan
    hi User4 ctermbg=darkgray ctermfg=lightgreen guibg=darkgray guifg=lightgreen
...
" 修改光标形状
    if &term =~ "xterm"
        ...
        " NORMAL mode
        let &t_EI = "\<Esc>[2 q" . "\<Esc>]12;#6c6c6c\x7"
    endif
