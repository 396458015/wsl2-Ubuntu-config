...
local vim_opts = {
    -- autochdir = true,  -- 设定文件浏览器目录为当前目录  --问题
...
-- {{{ chomosuke/typst-preview.nvim
  {
    ...
    config = function()
        require("typst-preview").setup {
            ...
            dependencies_bin = {
                tinymist = 'tinymist.cmd',  -- 使用Mason安装的tinymist
            },
        }
...
-- {{{ 396458015/imeflow.nvim
 {
  ...
  event = "InsertEnter",
  opts = {
      path = vim.fn.has("wsl") == 1 and "/mnt/c/Users/ThinkPad/AppData/Local/nvim-data/Maxl/im-select.exe" or nil,
